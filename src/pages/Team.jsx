...
export default function TeamPage() {
    const teamMembers = [
        ...
        { name: 'Manel Méndez', role: 'CFO', imageUrl: '/teams/manel.png', description: 'Expert en finances i estratègia empresarial amb més de 10 anys d\'experiència' },
        { name: 'Harry White', role: 'COO', imageUrl: '/teams/harry.png', description: 'Especialista en operacions i optimització de processos empresarials' },
    ];
